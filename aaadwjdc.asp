...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "duanqiwenjuandiaocha";
  var MM_editRedirectUrl = "adwjdc.asp";
...
%>
<%
var dwjdc = Server.CreateObject("ADODB.Recordset");
dwjdc.ActiveConnection = MM_connbbs_STRING;
dwjdc.Source = "SELECT * FROM duanqiwenjuandiaocha";
dwjdc.CursorType = 0;
dwjdc.CursorLocation = 2;
dwjdc.LockType = 1;
dwjdc.Open();
var dwjdc_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(dwjdc.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(dwjdc.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
