...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "shuqitie";
  var MM_editRedirectUrl = "alljjj.asp";
...
%>
<%
var rssq = Server.CreateObject("ADODB.Recordset");
rssq.ActiveConnection = MM_connbbs_STRING;
rssq.Source = "SELECT * FROM shuqitie";
rssq.CursorType = 0;
rssq.CursorLocation = 2;
rssq.LockType = 1;
rssq.Open();
var rssq_numRows = 0;
%>
      ...
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=Session("MM_Username")%>" />
              <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=Request.ServerVariables("REMOTE_ADDR")%>" /></td>
          <td><label>
