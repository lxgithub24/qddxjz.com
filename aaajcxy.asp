...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jiaqicuxiaoyuan";
  var MM_editRedirectUrl = "ajcxy.asp";
...
%>
<%
var jcxy = Server.CreateObject("ADODB.Recordset");
jcxy.ActiveConnection = MM_connbbs_STRING;
jcxy.Source = "SELECT * FROM jiaqicuxiaoyuan";
jcxy.CursorType = 0;
jcxy.CursorLocation = 2;
jcxy.LockType = 1;
jcxy.Open();
var jcxy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(jcxy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(jcxy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
