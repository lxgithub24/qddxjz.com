...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "yuleqita";
  var MM_editRedirectUrl = "ayqt.asp";
...
%>
<%
var yqt = Server.CreateObject("ADODB.Recordset");
yqt.ActiveConnection = MM_connbbs_STRING;
yqt.Source = "SELECT * FROM yuleqita";
yqt.CursorType = 0;
yqt.CursorLocation = 2;
yqt.LockType = 1;
yqt.Open();
var yqt_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(yqt.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(yqt.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
