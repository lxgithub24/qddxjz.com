...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xqt";
  var MM_editRedirectUrl = "vxqt.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM xuexiqita WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
