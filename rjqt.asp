...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jqt";
  var MM_editRedirectUrl = "vqt.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqiqita WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
