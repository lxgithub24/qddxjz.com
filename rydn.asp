...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "ydn";
  var MM_editRedirectUrl = "vydn.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM computer WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
