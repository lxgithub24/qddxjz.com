...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "yyp";
  var MM_editRedirectUrl = "vyyp.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM yuleyongpin WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
