...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "dwjdc";
  var MM_editRedirectUrl = "vdwjdc.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM duanqiwenjuandiaocha WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
