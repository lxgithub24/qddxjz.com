...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "duanqifuwuyuan";
  var MM_editRedirectUrl = "adfwy.asp";
...
%>
<%
var dfwy = Server.CreateObject("ADODB.Recordset");
dfwy.ActiveConnection = MM_connbbs_STRING;
dfwy.Source = "SELECT * FROM duanqifuwuyuan";
dfwy.CursorType = 0;
dfwy.CursorLocation = 2;
dfwy.LockType = 1;
dfwy.Open();
var dfwy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(dfwy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(dfwy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
