...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "dhq";
  var MM_editRedirectUrl = "vhq.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM duanqihunqing WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
