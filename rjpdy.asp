...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jpdy";
  var MM_editRedirectUrl = "vjpdy.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqipaidanyuan WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
