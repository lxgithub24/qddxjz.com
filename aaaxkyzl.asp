...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xuexikaoyanziliao";
  var MM_editRedirectUrl = "axky.asp";
...
%>
<%
var xkyzl = Server.CreateObject("ADODB.Recordset");
xkyzl.ActiveConnection = MM_connbbs_STRING;
xkyzl.Source = "SELECT * FROM xuexikaoyanziliao";
xkyzl.CursorType = 0;
xkyzl.CursorLocation = 2;
xkyzl.LockType = 1;
xkyzl.Open();
var xkyzl_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(xkyzl.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(xkyzl.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
