...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jiaqiqita";
  var MM_editRedirectUrl = "aqt.asp";
...
%>
<%
var jqt = Server.CreateObject("ADODB.Recordset");
jqt.ActiveConnection = MM_connbbs_STRING;
jqt.Source = "SELECT * FROM jiaqiqita";
jqt.CursorType = 0;
jqt.CursorLocation = 2;
jqt.LockType = 1;
jqt.Open();
var jqt_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(jqt.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(jqt.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
