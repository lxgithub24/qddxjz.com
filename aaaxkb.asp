...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xuexikeben";
  var MM_editRedirectUrl = "axess.asp";
...
%>
<%
var xkb = Server.CreateObject("ADODB.Recordset");
xkb.ActiveConnection = MM_connbbs_STRING;
xkb.Source = "SELECT * FROM xuexikeben";
xkb.CursorType = 0;
xkb.CursorLocation = 2;
xkb.LockType = 1;
xkb.Open();
var xkb_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(xkb.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(xkb.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
