...
<body bgcolor="#e0e0e0">
		...
		<tr>
			<td width="6%">
				<table width="100%" height="39%" border="0">
  				<tr>
  					<td>
  					<span class="STYLE17">早安青大</span><br/>
  					</td>
  				</tr>
  				<tr>
  					<td height="29">&nbsp;</td>
			...
			<td width="74%"><% while ((Repeat4__numRows-- != 0) && (!zaqd.EOF)) { %>
	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" table-layout:fixed>
      ...
      <td height="35" bgcolor="#FFD495" class="STYLE6 STYLE11">
        <span class="STYLE4">兼职信息</span>：
      </td>
      <td bgcolor="#FFD495"><div align="right"><a href="http://www.qdu.edu.cn/" class="STYLE8">转到 &nbsp;我们的校园</a></div></td>
    </tr><tr><td>短期</td><td>假期</td></tr>
    <tr>
          <td height="100%"> <table width="460" height="100%" border="0" bordercolor="#666666" cellpadding="01" cellspacing="1" table-layout:fixed>
            <tr>
              ...
              <tr>  <td width="100px"><div style="text-overflow:ellipsis;overflow:hidden;word-break:keep-all;white-space:nowrap;width:100px"><a href="viewdqjj.asp?<%= Server.HTMLEncode(MM_keepNone) + ((MM_keepNone!="")?"&":"") + "ArticleId=" + rsfatie.Fields.Item("ArticleId").Value %>"><%=(rsfatie.Fields.Item("topic").Value)%></a></div></td>
