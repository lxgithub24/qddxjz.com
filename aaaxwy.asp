...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xuexiwaiyu";
  var MM_editRedirectUrl = "axwy.asp";
...
%>
<%
var xwy = Server.CreateObject("ADODB.Recordset");
xwy.ActiveConnection = MM_connbbs_STRING;
xwy.Source = "SELECT * FROM xuexiwaiyu";
xwy.CursorType = 0;
xwy.CursorLocation = 2;
xwy.LockType = 1;
xwy.Open();
var xwy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(xwy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(xwy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
