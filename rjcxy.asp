...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jcxy";
  var MM_editRedirectUrl = "vjcxy.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqicuxiaoyuan WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
