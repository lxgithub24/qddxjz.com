...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "zaoanqingda";
  var MM_editRedirectUrl = "index.asp";
  var MM_fieldsStr = "txtContent|value|hiddenUsername|value|hiddenIP|value|Time|value";
  var MM_columnsStr = "Content|',none,''|Username|',none,''|IP|',none,''|PostTime|',none,NULL";
...
zaqd.Source = "SELECT * FROM zaoanqingda";
zaqd.CursorType = 0;
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(zaqd.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(zaqd.Fields.Item("IP").Value)%>" />
            <input type='hidden' name='Time' id='Time'/></td>
          <td><label>
