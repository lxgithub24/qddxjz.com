...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jsxs";
  var MM_editRedirectUrl = "vsxs.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqishixisheng WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
