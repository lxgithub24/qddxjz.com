...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "duanqipaidanyuan";
  var MM_editRedirectUrl = "adpdy.asp";
...
%>
<%
var dpdy = Server.CreateObject("ADODB.Recordset");
dpdy.ActiveConnection = MM_connbbs_STRING;
dpdy.Source = "SELECT * FROM duanqipaidanyuan";
dpdy.CursorType = 0;
dpdy.CursorLocation = 2;
dpdy.LockType = 1;
dpdy.Open();
var dpdy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(dpdy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(dpdy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
