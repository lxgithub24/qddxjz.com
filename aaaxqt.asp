...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xuexiqita";
  var MM_editRedirectUrl = "axqt.asp";
...
%>
<%
var xqt = Server.CreateObject("ADODB.Recordset");
xqt.ActiveConnection = MM_connbbs_STRING;
xqt.Source = "SELECT * FROM xuexiqita";
xqt.CursorType = 0;
xqt.CursorLocation = 2;
xqt.LockType = 1;
xqt.Open();
var xqt_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(xqt.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(xqt.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
