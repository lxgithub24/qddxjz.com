...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "yqt";
  var MM_editRedirectUrl = "vyqt.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM yuleqita WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
