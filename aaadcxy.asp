...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "duanqicuxiaoyuan";
  var MM_editRedirectUrl = "adcxy.asp";
...
%>
<%
var dcxy = Server.CreateObject("ADODB.Recordset");
dcxy.ActiveConnection = MM_connbbs_STRING;
dcxy.Source = "SELECT * FROM duanqicuxiaoyuan";
dcxy.CursorType = 0;
dcxy.CursorLocation = 2;
dcxy.LockType = 1;
dcxy.Open();
var dcxy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(dcxy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(dcxy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
