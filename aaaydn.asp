...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "computer";
  var MM_editRedirectUrl = "aydn.asp";
...
%>
<%
var ydn = Server.CreateObject("ADODB.Recordset");
ydn.ActiveConnection = MM_connbbs_STRING;
ydn.Source = "SELECT * FROM computer";
ydn.CursorType = 0;
ydn.CursorLocation = 2;
ydn.LockType = 1;
ydn.Open();
var ydn_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(ydn.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(ydn.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
