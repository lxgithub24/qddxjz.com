...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "dfwy";
  var MM_editRedirectUrl = "vdfwy.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM duanqifuwuyuan WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
