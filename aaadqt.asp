...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "duanqiqita";
  var MM_editRedirectUrl = "adqt.asp";
...
%>
<%
var dqt = Server.CreateObject("ADODB.Recordset");
dqt.ActiveConnection = MM_connbbs_STRING;
dqt.Source = "SELECT * FROM duanqiqita";
dqt.CursorType = 0;
dqt.CursorLocation = 2;
dqt.LockType = 1;
dqt.Open();
var dqt_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(dqt.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(dqt.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
