...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jfwy";
  var MM_editRedirectUrl = "vjfwy.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqifuwuyuan WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
