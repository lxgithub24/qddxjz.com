...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jiaqiqita2";
  var MM_editRedirectUrl = "ajqt2.asp";
...
%>
<%
var jqt2 = Server.CreateObject("ADODB.Recordset");
jqt2.ActiveConnection = MM_connbbs_STRING;
jqt2.Source = "SELECT * FROM jiaqiqita2";
jqt2.CursorType = 0;
jqt2.CursorLocation = 2;
jqt2.LockType = 1;
jqt2.Open();
var jqt2_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(jqt2.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(jqt2.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
