...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xkyzl";
  var MM_editRedirectUrl = "vxky.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM xuexikaoyanziliao WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
