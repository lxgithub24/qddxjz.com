...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "phone";
  var MM_editRedirectUrl = "aysj.asp";
...
%>
<%
var ysj = Server.CreateObject("ADODB.Recordset");
ysj.ActiveConnection = MM_connbbs_STRING;
ysj.Source = "SELECT * FROM phone";
ysj.CursorType = 0;
ysj.CursorLocation = 2;
ysj.LockType = 1;
ysj.Open();
var ysj_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(ysj.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(ysj.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
