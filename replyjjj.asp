...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jjj";
  var MM_editRedirectUrl = "viewjjj.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM shuqitie WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
