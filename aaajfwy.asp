...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jiaqifuwuyuan";
  var MM_editRedirectUrl = "ajfwy.asp";
...
%>
<%
var jfwy = Server.CreateObject("ADODB.Recordset");
jfwy.ActiveConnection = MM_connbbs_STRING;
jfwy.Source = "SELECT * FROM jiaqifuwuyuan";
jfwy.CursorType = 0;
jfwy.CursorLocation = 2;
jfwy.LockType = 1;
jfwy.Open();
var jfwy_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(jfwy.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(jfwy.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
