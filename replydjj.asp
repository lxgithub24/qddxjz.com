...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "djj";
  var MM_editRedirectUrl = "viewdqjj.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM fatie WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
