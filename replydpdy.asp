...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "dpdy";
  var MM_editRedirectUrl = "vdpdy.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM duanqipaidanyuan WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
