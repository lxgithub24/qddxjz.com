...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jiaqishixisheng";
  var MM_editRedirectUrl = "asxs.asp";
...
%>
<%
var jsxs = Server.CreateObject("ADODB.Recordset");
jsxs.ActiveConnection = MM_connbbs_STRING;
jsxs.Source = "SELECT * FROM jiaqishixisheng";
jsxs.CursorType = 0;
jsxs.CursorLocation = 2;
jsxs.LockType = 1;
jsxs.Open();
var jsxs_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(jsxs.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(jsxs.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
