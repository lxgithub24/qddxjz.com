...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "dqt";
  var MM_editRedirectUrl = "vdqt.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM duanqiqita WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
