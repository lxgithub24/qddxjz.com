...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "jqt2";
  var MM_editRedirectUrl = "vjqt2.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM jiaqiqita2 WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
