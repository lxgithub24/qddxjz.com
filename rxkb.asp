...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "xkb";
  var MM_editRedirectUrl = "vxess.asp";
...
rsReplies.Source = "SELECT ArticleId, Topic FROM xuexikeben WHERE ArticleId = "+ rsReplies__MMColParam.replace(/'/g, "''") + "";
