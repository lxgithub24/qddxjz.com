...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_editTable  = "yuleyongpin";
  var MM_editRedirectUrl = "ayyp.asp";
...
%>
<%
var yyp = Server.CreateObject("ADODB.Recordset");
yyp.ActiveConnection = MM_connbbs_STRING;
yyp.Source = "SELECT * FROM yuleyongpin";
yyp.CursorType = 0;
yyp.CursorLocation = 2;
yyp.LockType = 1;
yyp.Open();
var yyp_numRows = 0;
%>
  ...
  <table width="70%" height="243" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><table width="101%" height="239" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><input name="hiddenUsername" type="hidden" id="hiddenUsername" value="<%=(yyp.Fields.Item("Username").Value)%>" />
            <input name="hiddenIP" type="hidden" id="hiddenIP" value="<%=(yyp.Fields.Item("IP").Value)%>" /><input type='hidden' name='Time' id='Time'/></td>
          <td><label>
